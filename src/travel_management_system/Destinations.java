...
public class Destinations extends JFrame implements Runnable{
    ...
    @Override
    public void run() {
        String[] text = new String[]{"JW Marriot Hotel", "Mandarin Oriental Hotel", "Four Seasons Hotel", "Raddison Blue Hotel", "Classio Hotel", "The Bay Club Hotel", "Breeze Blow Hotel", "The Taj Hotel", "Happy Morning Hotel", "River View Hotel"};
        try{
            for(int i = 0; i < 9; i++) {
